  ...
  return (
    <div className="flex flex-col h-full bg-white rounded-2xl border border-slate-200 overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-slate-100 flex-shrink-0">
        <div>
          <h2 className="text-sm font-semibold text-slate-800">Predefined Event Templates</h2>
          <p className="text-xs text-slate-400 mt-0.5">Reusable templates to speed up event creation</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center h-48 gap-3 text-center">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-1">Create templates to pre-fill event details quickly</p>
            </div>
