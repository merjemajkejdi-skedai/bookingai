...
// (not from the automated WA/IG/Messenger OAuth signup flows)
// ---------------------------------------------------------------------------

const MANUAL_LEAD_STATUSES = ['cold', 'contacted', 'interested', 'negotiating', 'won', 'lost'];
const MANUAL_LEAD_TEAM_MEMBERS = ['Kejdi Merjemaj'];
